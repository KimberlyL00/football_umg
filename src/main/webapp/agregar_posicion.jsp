...
<head>
    <meta charset="UTF-8">
    <title>Agregar Posicion | Mundial 2026</title>
    <style>
...
<body>
<div class="container">
    <h1>Agregar Posicion</h1>
    <form method="post" action="agregar_posicion.jsp">
        <label>Descripcion</label>
        <input type="text" name="descripcion" placeholder="Ej: Portero, Defensa, Delantero" required />
        <input type="submit" class="btn-submit" value="Guardar Posicion" />
    </form>
    <a href="gestion_posiciones.jsp" class="back">← Volver</a>
</div>
</body>
</html>