...
<head>
    <meta charset="UTF-8">
    <title>Agregar Pais | Mundial 2026</title>
    <style>
...
<div class="container">
    <h1>Agregar Pais</h1>
    <form method="post" action="agregar_pais.jsp">
        <label>Nombre del Pais</label>
        <input type="text" name="nombre" placeholder="Ej: Mexico" required />
        <input type="submit" class="btn-submit" value="Guardar Pais" />
    </form>
    <a href="gestion_paises.jsp" class="back">← Volver</a>
</div>
</body>
</html>