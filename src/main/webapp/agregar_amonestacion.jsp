...
<%@page import="modelos.Amonestacion"%>
...
<%
    ...
    String colorTarjeta = request.getParameter("color_tarjeta");

    if (idPartidoStr != null && idJugadorStr != null && minutoStr != null && colorTarjeta != null) {
        ...
        a.setMinuto(Integer.parseInt(minutoStr));
        a.setColor_tarjeta(colorTarjeta);
        new AmonestacionDAO().insertar(a);
...
<head>
    <meta charset="UTF-8">
    <title>Registrar Amonestacion | Mundial 2026</title>
    <style>
...
<body>
<div class="container">
    <h1>Registrar Amonestacion</h1>
    <form method="post" action="agregar_amonestacion.jsp">
        <label>Partido</label>
        ...
        <label>Minuto</label>
        <input type="number" name="minuto" placeholder="Ej: 30" min="1" max="120" required />

        <label>Color de Tarjeta</label>
        <select name="color_tarjeta" required>
            <option value="">-- Selecciona --</option>
            <option value="Amarilla">Amarilla</option>
            <option value="Roja">Roja</option>
        </select>

        <input type="submit" class="btn-submit" value="Registrar Amonestacion" />
    </form>
    <a href="gestion_amonestaciones.jsp" class="back">← Volver</a>
</div>
</body>
</html>